  ...
  var ProductItemColorSwatch = function () {
    ...
    _createClass(ProductItemColorSwatch, [{
      ...
      value: function _attachListeners() {
        ...
        this.delegateElement.on('change', '.color-swatch__radio', this._colorChanged.bind(this));
    ...
    _createClass(CountrySelector, [{
      ...
      value: function _onCountryChanged() {
        ...
        provinces.forEach(function (data) {
          _this3.provinceSelect.options.add(new Option(data[1], data[0]));
        });
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__CountrySelector__ = __webpack_require__(8);
      ...
      value: function _fetchRatesForProduct() {
        ...
        fetch(window.theme.localeRootUrl + '/cart/add.js', {
          ...
          response.json().then(function () {
            var country = _this5.element.querySelector('[name="country"]').value,
                province = _this5.element.querySelector('[name="province"]').value,
                zip = _this5.element.querySelector('[name="zip"]').value;
            ...
            _this5._updateCartCookie(cartCookie);
          }).catch(function () {
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__components_ShippingEstimator__ = __webpack_require__(9);
      ...
      if (this.options['enableImageZoom']) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_4__helper_Responsive__["default"].matchesBreakpoint('supports-hover')) {
          this.element.querySelectorAll('.product-gallery__image').forEach(function (image) {
            _this6.driftObjects.push(new Drift(image, {
              containInline: _this6.options['zoomEffect'] === 'outside',
              inlinePane: window.innerWidth < 1024 ? true : _this6.options['zoomEffect'] !== 'outside',
              hoverBoundingBox: _this6.options['zoomEffect'] === 'outside',
              handleTouch: false,
    ...
    _createClass(ProductSection, [{
      ...
      value: function _initShopifyReviews() {
        ...
        window.SPRCallbacks.onFormSuccess = function () {
          _this7.element.querySelector('#shopify-product-reviews .spr-form').classList.add('spr-form-submitted');
        };
      ...
      value: function _createCarousel() {
        ...
        if (this.productGalleryElement && parseInt(this.productGalleryElement.getAttribute('data-image-count')) > 1) {
          ...
          filteredCells.forEach(function (item, index) {
            if (item.getAttribute('data-image-id') === _this8.productGalleryElement.getAttribute('data-initial-image-id')) {
              initialIndex = index;
            }
          });
      ...
      value: function _onGallerySlideChanged() {
        ...
        this.productThumbnailsCellsElements.forEach(function (item) {
          ...
          if (item.getAttribute('data-image-id') === _this9.flickityInstance.selectedElement.getAttribute('data-image-id')) {
            newNavElement = item;
          }
        });
      ...
      value: function _onVariantChanged(event) {
        ...
        fastdom.mutate(function () {
          _this10.productGalleryCellsElements.forEach(function (cell, imageIndex) {
            if (cell.hasAttribute('data-group-name')) {
              ...
              _this10.options['productOptions'].forEach(function (option, optionIndex) {
                if (option.toLowerCase() === groupName) {
                  ...
                  if (newVariant['option' + (optionIndex + 1)].toLowerCase() === cell.getAttribute('data-group-value') || newVariant['featured_image'] && newVariant['featured_image']['id'] === parseInt(cell.getAttribute('data-image-id'))) {
                    ...
                    _this10.productThumbnailsCellsElements[imageIndex].classList.remove('is-filtered');
                  } else {
                    cell.classList.add('is-filtered');
                    _this10.productThumbnailsCellsElements[imageIndex].classList.add('is-filtered');
                  }
                }
              });
          ...
          if (shouldReload) {
            _this10.flickityInstance.deactivate();
            _this10.flickityInstance.activate();
          }

          if (newVariant && newVariant['featured_image']) {
            _this10.flickityInstance.selectCell('[data-image-id="' + newVariant['featured_image']['id'] + '"]');
          }
        });
      }
    }]);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Cart = function () {
    ...
    _createClass(Cart, [{
      ...
      key: '_attachListeners',
      value: function _attachListeners() {
        this._windowResizedListener = this._windowResized.bind(this);

        if (window.theme.template !== 'cart') {
          this.delegateElement.on('click', '[data-action="toggle-mini-cart"]', this._toggleMiniCart.bind(this));
          this.delegateRoot.on('click', this._onClick.bind(this));

          window.addEventListener('resize', this._windowResizedListener);
        }
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__CountrySelector__ = __webpack_require__(8);
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_15__ShippingEstimator__ = __webpack_require__(9);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__components_CountrySelector__ = __webpack_require__(8);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__components_ShippingEstimator__ = __webpack_require__(9);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__helper_Form__ = __webpack_require__(4);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__ProductSection__ = __webpack_require__(10);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_6__sections_ProductSection__ = __webpack_require__(10);
      ...
      value: function _openQuickView(event, target) {
        ...
        fetch(productUrl.href, {
          ...
          response.text().then(function (content) {
            ...
            // Register a new section to power the JS
            new __WEBPACK_IMPORTED_MODULE_6__sections_ProductSection__["default"](modal.querySelector('[data-section-type="product"]'));
          });
        });
      }
      ...
      value: function _reload(pushState) {
        ...
        return fetch(this.currentUrl.toString(), {
          ...
          response.text().then(function (content) {
            ...
            _this37.element.querySelector('.collection__inner').innerHTML = tempElement.querySelector('.collection__inner').innerHTML;
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var HeaderSection = function () {
    function HeaderSection(element) {
      ...
      this.desktopNavigation = new __WEBPACK_IMPORTED_MODULE_0__components_DesktopNavigation__["default"](this.element.querySelector(this.options['navigationLayout'] === 'inline' ? '.nav-bar' : '.header__desktop-nav'), this.options['navigationLayout'], this.options['desktopOpenTrigger']);
      this.mobileNavigation = new __WEBPACK_IMPORTED_MODULE_1__components_MobileNavigation__["default"](this.element.querySelector('.header__mobile-nav'));
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_16__ProductSection__ = __webpack_require__(10);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  (function () {
    ...
    (function () {
      ...
      documentDelegate.on('click', '.card__expandable-toggle', function (item, expandableButton) {
        var parentSection = expandableButton.closest('.card__section');
        ...
        if (parentSection.getAttribute('aria-expanded') === 'true') {
          ...
          expandableButton.querySelector('.card__expandable-text').innerHTML = window.languages.productViewMore;
          ...
          expandableButton.querySelector('.card__expandable-text').innerHTML = window.languages.productViewLess;
        }
      });
    })();
